...
> **Stuck?** Open an issue at [github.com/use-ash/apex/issues](https://github.com/use-ash/apex/issues) and we'll help.

> **If you get stuck** at any point, don't worry — just head to [github.com/use-ash/apex/issues](https://github.com/use-ash/apex/issues) and describe what happened. Include a screenshot if you can. Someone will help.
...
![Apex chat interface showing a conversation with the AI](images/apex_chat_interface.png)
...
1. Go to [github.com/drm-collab/apex](https://github.com/drm-collab/apex) in your web browser.
...
![GitHub download ZIP button](images/github_download_zip.png)
...
```bash
git clone https://github.com/drm-collab/apex.git
```
...
![Terminal app on macOS](images/terminal_app.png)
...
![Setup wizard welcome screen](images/setup_wizard_welcome.png)
...
#### Step 1 of 6: Check Python packages
...
#### Step 2 of 6: Create data folders
...
#### Step 3 of 6: Detect your network
...
#### Step 4 of 6: Generate security certificates
...
![Certificate generation output](images/setup_cert_generation.png)

#### Step 5 of 6: Choose your workspace
...
![Model connections complete](images/setup_models_complete.png)
...
![Knowledge ingestion complete](images/setup_knowledge_complete.png)
...
![Setup complete, server running](images/setup_launch_complete.png)
...
![Certificate file in Finder](images/cert_file_finder.png)
...
![Keychain Access trust settings](images/keychain_trust_settings.png)
...
![Firefox certificate import](images/firefox_cert_import.png)
...
![Browser certificate selection dialog](images/browser_cert_prompt.png)
...
![Apex welcome screen](images/apex_welcome_screen.png)
...
![First chat interaction](images/first_chat_example.png)

---

## Step 6: (Optional) Add Agent Personas

Personas are pre-built AI personalities designed for specific roles. Instead of one generic AI, you can have a team:

| Persona | Role | What they are good at |
|---------|------|-----------------------|
| **Architect** | CTO | System design, code review, technical decisions |
| **Marketing** | CMO | Messaging, content strategy, market research |
| **Operations** | COO | Project tracking, budgets, milestones |
| **Codex** | Lead Dev | Writing code, building features, audits |
| **Kodi** | Utility | Quick questions, free local model, always available |

### How to install a persona

1. Open the Apex dashboard by going to **https://localhost:8300/admin** in your browser.
2. Navigate to the **Personas** section.
3. Choose a template from the available list.
4. Click **Install** -- this creates a new chat channel pre-configured with that persona's model and personality.

Each persona gets its own conversation channel with a specific AI model behind it. The Architect uses Claude Opus (the most powerful), Marketing uses Grok (for web research), and Kodi uses a free local model.

**Things to try with personas:**
- Ask the **Marketing** persona to write a product launch email
- Ask the **Architect** to review your system design
- Ask **Operations** to create a project timeline with milestones
- Ask **Codex** to write a script or debug a piece of code

> **Each persona uses a specific AI model.** If you didn't set up that model during the wizard, the persona won't work yet — but you can add the model later from the dashboard.

> **You do not need personas to use Apex.** They are an optional way to organize different types of work. Many people just use the default chat and are perfectly happy.
...
![iPhone certificate installation](images/iphone_cert_install.png)
...
> **Apex Pro (native iOS app):** For a better mobile experience, the Apex Pro iOS app is available as a subscription. It is a native app with push notifications, gesture navigation, and background streaming -- not just a website in a browser. Connect it to your server the same way.

...
SECRET_PATTERNS: list[re.Pattern[str]] = [
    ...
    re.compile(r"ghs_[a-zA-Z0-9]{20,}"),           # GitHub App installation tokens
    re.compile(r"ghu_[a-zA-Z0-9]{20,}"),           # GitHub user-to-server tokens
    re.compile(r"ghr_[a-zA-Z0-9]{20,}"),           # GitHub refresh tokens
]
...
def _detect_ai_conversations(workspace: Path) -> list[dict]:
    ...
    Returns list of dicts with keys: source, name, path, count, size_mb.
    """
    results: list[dict] = []

    ...
    el.innerHTML =
        '<div class="ws-summary-grid">' +
            '<div class="ws-summary-item" style="grid-column:span 2; text-align:left;">' +
                ...
                '</div>' +
                '<textarea id="ws-paths-editor" rows="3" class="ws-textarea" style="min-height:96px; margin-bottom:8px;" placeholder="/home/user/project-a&#10;/home/user/project-b">' + esc(pathsText) + '</textarea>' +
